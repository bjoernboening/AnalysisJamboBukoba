...
PassRatio.2012.mean[is.na(PassRatio.2012.mean)] <- 0
# mach das überhaupt sinn hier erst die NAs zu beseitigen???
...
PassRatio.2013.mean[is.na(PassRatio.2013.mean)] <- 0
# mach das überhaupt sinn hier erst die NAs zu beseitigen???
...
PassRatio.2014.mean[is.na(PassRatio.2014.mean)] <- 0
# mach das überhaupt sinn hier erst die NAs zu beseitigen???
